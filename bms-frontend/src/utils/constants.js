...
export const API_BASE_URL = import.meta.env.VITE_BACKEND_URL || 'http://localhost:9000';
export const SEAT_TYPES = [
  { label: 'Standard', price: 250, color: 'bg-slate-300' },
  { label: 'Premium', price: 350, color: 'bg-amber-400' },
  { label: 'VIP', price: 450, color: 'bg-rose-500' },
  { label: 'Executive', price: 300, color: 'bg-emerald-500' },
];
export const CITY_OPTIONS = ['Mumbai', 'Delhi', 'Bengaluru', 'Hyderabad'];
